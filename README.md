...
<html lang="en">
  ...
  <body class="bg-white">
    ...
    >
      ...
      >
        <img src="assets/logo.png" alt="RANA WEBSITE DESIGNERS" width="80" height="80" id="site-logo" />
        <a href="#" class="text-2xl font-['Pacifico'] text-primary ml-3">RANA WEBSITE DESIGNERS</a>
    ...
    >
      ...
      <div class="container mx-auto px-6 py-20 md:py-32 relative">
        <div class="max-w-2xl">
          ...
          >
            Creative Web Designer, Developer & Computer solutions
          </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6">
              ...
              <p class="text-gray-600 text-sm mb-3">Web design, maintenance, development</p>
              <a
                href="#"
          ...
          >
            <div class="relative h-64">
              <img
                src="https://readdy.ai/api/search-image?query=computer%20solutions%20website&width=600&height=400&seq=4&orientation=landscape"
              ...
              >
                <div class="text-center text-white">
                  ...
                  <p class="mb-4">
                    An elegant website for a comprehensive computer solutions and IT consultation featuring
    ...
    <footer class="bg-gray-900 text-white pt-16 pb-8">
      <div class="container mx-auto px-6">
        ...
        >
          <div>
            <img src="assets/logo.png" alt="RANA WEBSITE DESIGNERS" width="50" height="50" />
            <a
              href="#"
